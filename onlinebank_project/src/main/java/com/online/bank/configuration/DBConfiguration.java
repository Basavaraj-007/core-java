...
public class DBConfiguration {
	//this class to support JPA Entity Manager Factory object creation, i,e replacement of persistance.xml
	...
	public LocalContainerEntityManagerFactoryBean factoryBean(DataSource dataSource) {
		...
		bean.setPackagesToScan("com.online");
	...
	public DataSource dataSource() {
		...
		driverManagerDataSource.setUrl("jdbc:mysql://localhost:3306/basavaraj");
		driverManagerDataSource.setUsername("root");
		driverManagerDataSource.setPassword("Xworkzodc@123");
		//note learn what is connection pool;		
